...
public class Funcionario extends Pessoa {
	...
	@JsonIgnore //porque eu não quero que o funcionario retorne os serviços correspondentes, porque o serviço já retorna o funcionario e aí vira referência cíclica
